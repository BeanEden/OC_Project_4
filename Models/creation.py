...
def match_instance_creation_from_data_base(dict_match, round_of_the_match):
    ...
    player_one_instance = player_instance_creation_from_data_base(player_one_creation)
    p_two_id = dict_match["player_two"]
    player_two_creation = db_players.search_player_in_data_base(p_two_id)
    player_two_instance = player_instance_creation_from_data_base(player_two_creation)
...
def player_list_score_generator(tournament):
    ...
    for player in tournament.players_list.values():
        player_one_instance = player_instance_creation_from_data_base(db_players.search_player_in_data_base(player))
        player_score_generator(player_one_instance, tournament)
...
def secondary_rounds_method(round_played, player_list_instances):
    ...
    while match_count < round_played.matches_number:
        ...
        player_one_opponents_list = opponents_list_construction(player_one_instance.id, round_played.tournament_name)
